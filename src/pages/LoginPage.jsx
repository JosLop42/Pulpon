...
export default function LoginPage() {
  ...
  return (
    <div className="page">
      ...
      {/* Área central que ocupa todo el espacio disponible */}
      <div style={{ flex:1, display:'flex', alignItems:'center', justifyContent:'center', padding:'1rem', position:'relative', zIndex:1 }}>
